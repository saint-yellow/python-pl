...
if __name__ == "__main__":
    listHead = SinglyLinkedNode.buildList([2, 1, 3, 5, 6, 4, 7])
    print(SinglyLinkedNode.listAllValues(listHead))

    s = Solution()
    print(SinglyLinkedNode.listAllValues(s.oddEvenList(listHead)))
